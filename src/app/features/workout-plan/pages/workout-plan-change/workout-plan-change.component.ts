...
import { EDifficulty } from '../../shared/enums/EDifficulty';
import { EGoal } from '../../shared/enums/EGoal';
  ...
  userPrograms: WorkoutCard[] = [
    {
      ...
      editable: true,
      goal: EGoal.Athletics,
      status: EStatus.Published,
      difficulty: [EDifficulty.Intermediate, EDifficulty.Advanced],
    },
  ];
}
